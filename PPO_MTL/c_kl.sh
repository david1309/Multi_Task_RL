...
python train.py BipedalWalker-v2 --episode_to_load -1 --now_to_load Jul-24_18:56:22 --task_params 0 1 2 --task_name PPO_loss_mtl -dcore 64 64 -dhead 64 --pol_loss_type kl --num_episodes 20000 --batch_size 20 --save_rate 500
