...
# Modified Lunar lander Envioments:
register(
    id='LunarLanderGoal-v2',
    entry_point='gym.envs.box2d:LunarLanderModContinuousGoal',
    max_episode_steps=1000,
    reward_threshold=200,
)

register(
    id='LunarLanderNotGoal-v2',
    entry_point='gym.envs.box2d:LunarLanderModContinuousNotGoal',
    max_episode_steps=1000,
    reward_threshold=200,
)

register(
    id='LunarLanderFly-v2',
    entry_point='gym.envs.box2d:LunarLanderModContinuousFly',
    max_episode_steps=1000,
    reward_threshold=200,
)
